...
$(document).ready(function () {
    ...
    function buildToolTipArea(name, fullName) {
        return $('<div id="' + name + '_divID"><div>' + fullName + '</div><div>' +
            '<div><input id="tt_' + name + '_swol" type="checkbox" name="' + name + '" /><span class="sel" key="' + name + '">Inflammation</span></div>' +
            '<div><input id="tt_' + name + '_tend" type="checkbox" name="' + name + '" /><span class="sel" key="' + name + '">Tension</span></div></div></div>');
    }
